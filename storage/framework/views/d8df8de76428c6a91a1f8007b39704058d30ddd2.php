    ...
    <div class="col-md-12">
        <div class="page-header">
            ...
            <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                    <a href="/Sekolah"><?php echo e($title); ?></a>
                </li>
            </ul>
        </div>
        <div class="card">
                    ...
                    <table id="datatables" class="display table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td><?php echo e($no++); ?></td>
                                    <td><?php echo e($a->nama_sekolah); ?></td>
                                    <td><?php echo e($a->alamat); ?></td>
                                    <td><?php echo e($a->created_at); ?></td>
                                    <td><button data-target="#edit-sekolah<?= $a->id ?>" type="button" data-toggle="modal"
                                            title="Edit Data" class="btn btn-link btn-primary btn-lg"
                                            data-original-title="Edit Task">
                                            <i class="fa fa-edit"></i>
                                        </button>

                                        <button data-id="<?php echo e($a->id); ?>" data-name="<?php echo e($a->nama_sekolah); ?>"
                                    ...
                                    <div class="modal fade" id="edit-sekolah<?= $a->id ?>" tabindex="-1" role="dialog"
                                        aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="/proses_edit_sekolah/<?php echo e($a->id); ?>" method="POST"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group form-group-default">
                                                                    ...
                                                                    <input id="nama_sekolah" name="nama_sekolah"
                                                                        value="<?= $a->nama_sekolah ?>" type="text"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="modal fade " id="add-sekolah" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header no-bd">
                    <h5 class="modal-title">
                ...
                <div class="modal-body">
                    <form action="/proses_add_sekolah" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-default">
                                    <label>Nama Sekolah</label>
                                    <input id="nama_sekolah" name="nama_sekolah" type="text"
                                        class="form-control <?php $__errorArgs = ['nama_sekolah'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
            ...
            function getdeleteid(e) {
                ...
                swal({
                    ...
                    .then((willDelete) => {
                        ...
                        if (willDelete) {
                            $.ajax({
                                url: "<?php echo e(route('sekolah.delete_sekolah')); ?>",
                                datatype: "json",
                                method: "POST",
                                data: {
...
<?php echo $__env->make('layouts.adm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Documents/data/project/spp/resources/views/sekolah/index.blade.php ENDPATH**/ ?>