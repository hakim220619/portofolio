...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <form class="student" method="post" action="/proses_add_student" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    ...
                                    id="nis" name="nis" placeholder="Masukan nis" required>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                    id="nisn" name="nisn" placeholder="Masukan nisn" required>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');"
                                    id="phone" name="phone" placeholder="Masukan phone" required>
                        ...
                        <div class="col-md-4 col-lg-4">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="hobby" name="hobby"
                                    placeholder="Masukan Hobby" required>
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="form-group">
                                ...
                                <textarea name="address" class="form-control" id="address" cols="135" rows="2"></textarea>
...
<?php echo $__env->make('layouts.adm', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookpro/Documents/data/project/spp/resources/views/student/add_student.blade.php ENDPATH**/ ?>