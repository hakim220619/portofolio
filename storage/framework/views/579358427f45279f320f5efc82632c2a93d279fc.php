                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input type="text" name="name_category" value="<?php echo e(old('name_category')); ?>"
                    ...
                    , success: function(data) {
                        ...
                        for (i = 0; i < data.length; i++) {
                            html += '<tr>' +
                                ...
                                '<td>' +
                                '<button id="editModal" data-action="/CategoryEdit/' + data[i].id +
                                '" data-id="' + data[i].id +
                                '" class="btn btn-warning btn-sm btn-round">Edit</button> <button id="btn-delete" data-id="' +
                                data[i].id + '" data-name="' + data[i].name_category +
                                '"onclick="getdeleteid(this)" class="btn btn-danger btn-sm btn-round">Delete</button>' +
                                '</td>' +
                                '</tr>';
                        }
                        $('#show_data').html(html);
        ...
        function getdeleteid(e) {
            ...
            swal({
                ...
                .then((willDelete) => {
                    ...
                    if (willDelete) {
                        $.ajax({
                            url: "<?php echo e(route('Category.DeleteCategory')); ?>"
                            , datatype: "json"
                            , method: "POST"
                            , data: {
